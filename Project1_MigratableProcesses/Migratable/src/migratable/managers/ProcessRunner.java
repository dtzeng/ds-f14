...
public class ProcessRunner implements Runnable {
    ...
    public ProcessRunner(ProcessThread processThread, Map<String, ProcessThread> processes, String masterHost, int masterPort) {
    ...
    public void run() {
        ...
        try {
            ...
            if(!response.getSuccess()) throw new Exception("Failed to delete object");
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            try {
