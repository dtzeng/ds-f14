...
\par\qquad As seen in the previous section, the key of the MapReduce framework is its management of concurrent network requests, especially at the Master node. The following two sub-sections will survey the network interactions between MapReduce Master node and the two other major components. 
