...
/**
 * Created by Derek on 11/14/2014.
 */
public class QueuedTasks {
    ...
    public String toString() {
        ...
        while (iterator.hasNext()) {
            ...
            result += task.getTaskType() + task.getTaskID() + " (Job " + task.getSourceJobID() + "), pending";
        ...
        while (iterator.hasNext()) {
            TaskInfo task = iterator.next();
            result += "|";
            result += task.getTaskType() + task.getTaskID() + " (Job " + task.getSourceJobID() + "), waiting";
        }
