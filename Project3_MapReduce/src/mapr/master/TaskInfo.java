...
public class TaskInfo implements Serializable {
    ...
    // New map
    public TaskInfo(String taskType, String input, String output, int recordStart, int recordEnd, int taskID,
                    String otherArgs, int sourceJobID, String jobType) {
    ...
    // New sort
    public TaskInfo(String taskType, String input, String output, int taskID, int dependency, int sourceJobID, String jobType) {
        this.taskType = taskType;
        this.input = input;
        this.output = output;
        this.taskID = taskID;
